  ...
  return (
    <footer className="w-full border-t border-line">
      ...
      <div className="border-t border-line">
        <div className="flex w-full flex-col gap-3 px-4 py-5 text-xs text-muted sm:flex-row sm:items-center sm:justify-between lg:px-6">
          <span>© 2026 Mercury Computers Limited. All Rights Reserved.</span>
